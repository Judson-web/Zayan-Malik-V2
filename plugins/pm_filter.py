        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    ...
                    InlineKeyboardButton('🆁🅴🅿️🅾️', elif query.data == "source":   await query.answer("സോഴ്സ് കോഡ് തർനെ എനിക്ക് മനസില്ല ഓണ് പോട അവൻ്റെ ഒരു സോഴ്സ് കോടെ phha",show_alert=True),
                ]
                ]
